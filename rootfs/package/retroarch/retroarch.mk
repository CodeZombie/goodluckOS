...
define RETROARCH_BUILD_CMDS
    $(TARGET_MAKE_ENV) $(TARGET_CONFIGURE_ARGS) $(MAKE) AS="$(TARGET_CC) -c" ASFLAGS="$(TARGET_CFLAGS)" -C $(@D)
    $(TARGET_MAKE_ENV) $(MAKE) $(TARGET_CONFIGURE_OPTS) -C $(@D)/libretro-common/audio/dsp_filters
    $(TARGET_MAKE_ENV) $(MAKE) $(TARGET_CONFIGURE_OPTS) -C $(@D)/gfx/video_filters
endef
...
define RETROARCH_INSTALL_TARGET_CMDS
    ...
    $(TARGET_MAKE_ENV) $(MAKE) $(TARGET_CONFIGURE_OPTS) PREFIX=$(TARGET_DIR) -C $(@D)/libretro-common/audio/dsp_filters install
    $(TARGET_MAKE_ENV) $(MAKE) $(TARGET_CONFIGURE_OPTS) PREFIX=$(TARGET_DIR) -C $(@D)/gfx/video_filters install
